...
{
    [Authorize]
    public abstract class KucniLjubimciController<T,TDR,TDI> : ControllerBase where T : Entitet
    {
        ...
        protected readonly KucniLjubimciContext _context;

        public KucniLjubimciController(KucniLjubimciContext context)
        {
            _context = context;
        ...
        protected virtual T NadiEntitet(int sifra) // load entity
        {
        ...
        protected virtual List<TDR> UcitajSve() // load entites
        {
        ...
        protected virtual T KreirajEntitet(TDI dto) // create entity
        {
            return _mapper.MapInsertUpdatedFromDTO(dto);
        }

        protected virtual T PromjeniEntitet(TDI dto, T s) // edit entity
        {
            return _mapper.MapInsertUpdatedFromDTO(dto);
        }
